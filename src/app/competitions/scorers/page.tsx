...
export default function CompetitionScorersPage() {
  return (
    <SectionIndexPage
      ...
      title="射手记录"
      description="按赛事查看已公布的进球统计与射手奖项。"
      sectionTitle="赛事射手数据"
      notice="男足完整统计与女足金靴奖项分别保留在对应赛事归档；女足完整射手榜仍待赛事方确认。"
      items={[
        { title: "2026男子足球院际杯", description: "查看赛事进球统计、射手数据与奖项记录。", meta: "69粒赛事进球", status: "已归档", href: "/competitions/2026-mens-intercollege-cup#statistics", actionLabel: "查看射手数据" },
