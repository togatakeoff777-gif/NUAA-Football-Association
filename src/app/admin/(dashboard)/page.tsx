    ...
    <>
      ...
      <AdminPanel title="授权模块" description="页面、接口和服务均按当前账号权限执行服务端校验。">
        <div className="admin-task-list">
          ...
          {canReadReferees ? <article className="admin-task-item"><i /><div><strong>裁判中心</strong><p>统一维护裁判员档案、准入、可执裁时间与选派记录。</p></div><Link href="/admin/referees">查看裁判员</Link></article> : null}
