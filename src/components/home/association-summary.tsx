...
export function AssociationSummary() {
  return (
    <section className="home-association-summary" aria-labelledby="home-association-title">
      <div className="page-shell association-summary-grid">
        <div className="association-summary-copy">
        ...
        <dl className="association-summary-stats">
