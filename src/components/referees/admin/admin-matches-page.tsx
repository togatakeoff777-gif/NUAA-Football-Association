...
export async function AdminMatchesPageContent({
  ...
  return <>
    <AdminPageHeader
      ...
      description={isAppointmentView ? "从比赛 reference 列表进入具体场次，维护岗位与正式选派。" : "维护比赛资料；裁判选派在裁判中心独立管理。"}
