...
export function CurrentCompetitions() {
  ...
  return (
    <section className="home-current-competitions" aria-labelledby="home-competitions-title">
      <div className="page-shell">
        ...
        <div className="current-competition-layout">
          <article className="featured-competition-card" id={featured.slug}>
          ...
          <div className="compact-competition-list">
