...
export const arbitrationPublicNotice =
  "申诉应在比赛结束后48小时内提出。确认受理后，赛事组织方将另行通知听证及后续处理安排。提交渠道、材料要求和受理主体以对应赛事规程、纪律决定或赛事通知为准。";
...
export const arbitrationGuide = {
  ...
  deadline: "申诉应在比赛结束后48小时内提出；确认受理后，由赛事组织方另行通知听证及后续处理安排。",
  materials: [
    "申请事项、事实经过与明确请求",
    "对应比赛、队伍、人员与时间信息",
    "能够支持申请的原始材料或公开记录",
  ...
  process: [
    ...
    { id: "hearing", title: "听证与处理", description: "确认受理后，由赛事组织方另行通知听证及后续处理安排，并依对应规则审议处理。" },
